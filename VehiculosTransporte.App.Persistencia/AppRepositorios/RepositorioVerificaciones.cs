...
namespace VehiculosTransporte.App.Persistencia.AppRepositorios
{
    public class RepositorioVerificaciones: IRepositorioVerificaciones
    {
        ...
        Persona IRepositorioVerificaciones.AddVerificacion(Verificacion verificacion)
        {
        ...
        {
            var verificacionEncontrada = _appContext.Verificaciones.FirstOrDefault(p => p.Id == persona.Id);
            if (verificacionEncontrada != null)
            {
                verificacionEncontrada.Vehiculo = verificacion.Vehiculo;
                verificacionEncontrada.Nivel_Aceite = verificacion.Nivel_Aceite;
                verificacionEncontrada.Nivel_Liquido_frenos = verificacion.Nivel_Liquido_frenosa;
